...
NULL_MAIN_LOOP = None # (!) real value is '<dbus.mainloop.NativeMainLoop object at 0x7fc8cf3751b0>'

_C_API = None # (!) real value is '<capsule object "_dbus_bindings._C_API" at 0x7fc8cf375180>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc8d04a3a90>'

__spec__ = None # (!) real value is "ModuleSpec(name='_dbus_bindings', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc8d04a3a90>, origin='/usr/lib/python3/dist-packages/_dbus_bindings.cpython-36m-x86_64-linux-gnu.so')"
