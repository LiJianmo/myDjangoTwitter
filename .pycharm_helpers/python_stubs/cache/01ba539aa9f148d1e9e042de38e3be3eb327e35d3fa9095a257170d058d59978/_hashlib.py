...
openssl_md_meth_names = None # (!) real value is "frozenset({'shake256', 'sm3', 'sha3-256', 'sha1', 'sha3-512', 'ripemd160', 'blake2b512', 'md4', 'whirlpool', 'blake2s256', 'md5', 'sha3-384', 'sha512-224', 'sha384', 'sha512-256', 'sha3-224', 'sha512', 'sha256', 'shake128', 'md5-sha1', 'sha224'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc8d0458c50>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc8d0458c50>, origin='/usr/lib/python3.6/lib-dynload/_hashlib.cpython-36m-x86_64-linux-gnu.so')"
