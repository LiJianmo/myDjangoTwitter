...
class FriendshipApiTests(TestCase):
    ...
    def _test_friendship_pagination(self, url, page_size, max_page_size):
        ...
        self.assertEqual(response.data['total_results'], page_size * 3)
        ...
        print(response.data['total_results'])  # 60    60
        print(response.data['page_number'])  # 1     3
        print(response.data['total_pages'])  # 3     3
        ...
        self.assertEqual(response.data['total_results'], page_size * 3)
        # print(response.data['page_number'])
