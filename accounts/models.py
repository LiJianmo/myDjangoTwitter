...
# 访问到对应的 profile 信息。
#
#一个基于object的cache， '_cached_user_profile'
#属性级别的cache，作用域是user的object被更换就失效
#quickly get profile from one user
#也可以写一个service 里面classmethod get_profile, 但查询不同的attr 会产生多次查询
#所以用User.profile = property(get_profile)
